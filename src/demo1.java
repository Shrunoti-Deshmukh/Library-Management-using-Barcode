...
public class demo1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("    Kindly Enter the PRN To Search The Student");
        ...
        jLabel8.setText("    Kindly Enter the PRN To Search The Student");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        String prn = jTextField10.getText();
        if (prn.equals("") || prn.equals("PRN")) {
            JOptionPane.showMessageDialog(rootPane, "Please Enter PRN Number to Delete Student");
        }
        else{
            dBConnection.deleteStudent(prn);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (prn.equals("") || prn.equals("PRN")) {
            JOptionPane.showMessageDialog(rootPane, "Please Enter PRN Number to Search Student");
        }
        else{
            ...
            for(int i=0;i<strsplit.length;i++){
                ...
                if(strsplit[i].contains("name")){
                    ...
                    jTextField6.setText(split2[1]);
                }

                if(strsplit[i].contains("prn")){
                    String[] split2 = strsplit[i].split("=",2);
                    jTextField8.setText(split2[1]);
                }

                if(strsplit[i].contains("mail")){
                    String[] split2 = strsplit[i].split("=",2);
                    jTextField7.setText(split2[1]);
                }

                if(strsplit[i].contains("contact")){
                    String[] split2 = strsplit[i].split("=",2);
                    jTextField9.setText(split2[1]);
                }
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (prn.equals("") || prn.equals("PRN") || name.equals("") || name.equals("Name") || mail.equals("") || mail.equals("Email") || contact.equals("") || contact.equals("Contact")) {
            JOptionPane.showMessageDialog(rootPane, "Please Enter All the Fields to Insert Student");
        }
        Vector books = new Vector(2);
        Student s1 = new Student(prn, name, mail, books, contact);
        //dBConnection.setUserDatabase();
        String str = dBConnection.addStudent(s1);
        JOptionPane.showMessageDialog(rootPane, "Student Inserted");        
